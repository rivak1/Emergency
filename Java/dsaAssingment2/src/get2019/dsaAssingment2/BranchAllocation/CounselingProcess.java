...
public class CounselingProcess {
	...
	/**
	 * this function is used to add all the program itnto the program list object type
	 * @param capacity contian the capacity of branch
	 * @param Branch   contian the name of branch
