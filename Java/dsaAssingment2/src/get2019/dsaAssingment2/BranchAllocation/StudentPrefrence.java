...
public class StudentPrefrence {
	...
	public void readExcel() throws BiffException, IOException {
		...
		//add all the studentDetails into student class and take object of perticular student
	 ...
	 * @param name contain the name of student
	 * @param studentBranch contain all the branches of student
